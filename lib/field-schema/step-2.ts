...
export const step2Fields: FieldSchema[] = [
  ...
  { name: "employmentStatus",    type: "select",    label: "Tình trạng việc làm",   categoryId: "employment_status" },
  ...
  { name: "incomeSource",        type: "select",    label: "Nguồn thu nhập khác",    categoryId: "income_source", colSpan: 2 },
